...
class Network:
    ...
    def __calculate_neuron_inputs_and_activations(self, inputs: numpy.ndarray) -> (
    ...
    def __layer_input_gradient(self, inputs: numpy.ndarray) -> numpy.ndarray:
